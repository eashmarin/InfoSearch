...
$mysql_user); 
if (!$conn ) die("Íåò ñîåäèíåíèÿ ñ MySQL");

$query = "create database sample";

$result = mysql_query($query) 
          or die ("<p>Îøèáêà: ".mysql_error());;


$database = "sample";
mysql_select_db($database) 
or die ("Íåëüçÿ îòêðûòü $database");

#Òåïåðü ñîçäàäèì òàáëèöû â áàçå study:

#	ñîçäàíèå òàáëèöû ïðîäàâöîâ - SAL
#
...
#
#	ñîçäàíèå òàáëèöû çàêàç÷èêîâ - CUST
#
...
#   
#Òàáëèöû ñîçäàíû, âíåñåì â íèõ äàííûå:
#
#	çàïîëíåíèå òàáëèöû sal
#
...
echo "Ñîçäàíèå è çàïîëíåíèå òàáëèö âûïîëíåíî";
